...
```javascript
import iterLength from 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-length@v0.2.3-deno/mod.js';
```
...
[@stdlib/iter/counter]: https://github.com/stdlib-js/iter-counter/tree/deno
